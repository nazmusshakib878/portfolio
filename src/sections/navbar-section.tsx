        ...
        <Container className="pointer-events-auto">
          <div
            className={cn(
              ...
              isScrolled && 'border-border/70 bg-background/88 py-2.5 shadow-[0_16px_50px_rgba(15,23,42,0.12)] supports-[backdrop-filter]:bg-background/84'
            )}
          >
            <a
              href="#hero"
            ...
            >
              <span className="flex size-10 items-center justify-center rounded-full border border-sky-400/40 bg-gradient-to-br from-sky-500/20 via-cyan-500/20 to-violet-500/20 text-sm font-semibold text-foreground shadow-sm backdrop-blur-md">
                {portfolioData.initials}
              </span>
              <span className="hidden flex-col leading-none sm:flex">
                <span className="font-heading text-sm font-semibold">{portfolioData.name}</span>
                <span className="text-xs text-muted-foreground">{portfolioData.primaryRole}</span>
              </span>
            </a>

            <nav className="hidden items-center gap-1 rounded-full border border-border/60 bg-card/75 p-1 shadow-sm backdrop-blur-md lg:flex" aria-label="Primary navigation">
                ...
                return (
                  <a
                    ...
                    className={cn(
                      ...
                      isActive && 'bg-gradient-to-r from-sky-500 via-cyan-500 to-violet-600 text-white shadow-[0_10px_24px_rgba(14,165,233,0.24)] hover:text-white'
                    )}
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="lg:hidden">
                <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                  ...
                  <SheetContent side="right" className="w-[min(100vw-1rem,22rem)] border-l border-border/60 bg-background/96 px-4 py-6 backdrop-blur-xl">
                    ...
                    <div className="mt-6 grid gap-3">
                      <Button variant="outline" className="rounded-full" render={<a href={portfolioData.resumeHref} download />}>
                        Resume
                      </Button>
