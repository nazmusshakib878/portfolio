...
export const portfolioData: PortfolioData = {
  ...
  technologyShowcase: [
    ...
    { name: 'Google Colab' },
    { name: 'VS Code' },
    { name: 'Frontend with AI', description: 'UI & interactions', ai: true },
    { name: 'Backend with AI', description: 'Logic & systems', ai: true },
    { name: 'API & Data with AI', description: 'Integration & flow', ai: true },
    { name: 'Any AI, as needed', description: 'Tool-agnostic workflow', ai: true },
  ],
  aboutCards: [
    {
      title: 'Location',
  ...
  professionalStrengths: [
    {
      title: 'Leadership',
      description: 'Experience coordinating team responsibilities and supporting collaborative project work.',
    },
    {
      title: 'Testing',
      description: 'Experience checking application behavior, debugging issues, and verifying dependable workflows.',
    },
    {
      title: 'Documentation',
      description: 'Experience preparing clear technical documentation for project structure, features, and usage.',
    },
    {
      title: 'Tutorial & Knowledge Sharing',
      description: 'Experience explaining technical topics through tutorials and practical guidance.',
    },
  ],
  experience: [
    {
  ...
  githubRepos: [
...

    {
      ...
      description:
        'Country-to-country transport and courier supply project where I supported Laravel, PHP, and database integrity workflows.',
