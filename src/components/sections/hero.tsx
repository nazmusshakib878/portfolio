...
export function Hero(){
  return <section id="hero" className="relative overflow-hidden pt-20">
    ...
    <div className="shell relative z-10 grid items-center gap-10 py-12 sm:py-14 lg:grid-cols-[1.02fr_.98fr] lg:gap-16 lg:py-16">
      <div className="relative z-20">
        <p className="eyebrow flex items-center gap-3"><span className="h-px w-9 bg-[#2bd9b5]"/>Reliable systems / thoughtful interfaces</p>
        <h1 className="display mt-5 max-w-[650px] text-[clamp(3rem,5vw,4.9rem)] font-semibold text-[#f2f3f7]">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <a className="button primary" href="#projects">View projects <ArrowDown size={15}/></a>
          <a className="button" href={portfolioData.resumeHref} download>Download resume <Download size={15}/></a>
          <a className="contact-link" href="#contact">Contact me <ArrowUpRight size={14}/></a>
        </div>
      ...
      <div className="relative mx-auto h-[330px] w-full max-w-[450px] sm:h-[410px] lg:h-[500px] lg:max-w-[460px]">
        <HeroVisual/>
